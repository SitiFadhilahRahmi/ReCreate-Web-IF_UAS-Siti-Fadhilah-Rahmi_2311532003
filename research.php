...
<body
    class="page-template page-template-templates page-template-template-flex-content page-template-templatestemplate-flex-content-php page page-id-511 page-parent wp-embed-responsive mega-menu-primary edge page-research no-js">
    ...
    <div class="site">
        ...
        <main id="main" class="site-content" role="main">
            <div class="page-content">
                        ...
                        <div class="hero__container">
                            <div class="hero__content">
                                <h1 class="hero__title">
                                    <span>Riset dan Penelitian</span>
                                </h1>
                        </div>
                    </div>
                </section>
                ...
                <?php include 'pages\content\researchnews.php'; ?>
                <!--fwp-loop-->
            </div>
        </main>
